...
var box = document.getElementById('box');
    ...
    $(window).scroll(function(){
        ...
        if(dmt-wid<=top+2){               //文件高度-可视高度<=滚动高度
                    // 模拟 ajax 获取数据
                    var datas = [
                        '<a href="player.html" class="swiper-slide item"><div class="slide"><img src="image/c.jpg"><p>6号</p><p>张三</p><p>396票</p><span>投票</span></div></a>',
                        '<a href="player.html" class="swiper-slide item"><div class="slide"><img src="image/cs6.jpg"><p>7号</p><p>张三</p><p>396票</p><span>投票</span></div></a>'
                    ];
                    var box = document.getElementById('box');
